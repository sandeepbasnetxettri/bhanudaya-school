...
<head>
    ...
    <title>Our Faculty - Excellence School</title>
...
<body>
        ...
        <nav class="navbar" id="navbar">
            <div class="container">
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="active">About <i class="fas fa-chevron-down"></i></a>
    ...
    <section class="page-banner">
        <div class="container">
            <h1>Our Faculty</h1>
            <p><a href="../index.php">Home</a> / <a href="#">About</a> / Faculty</p>
        </div>
    </section>
    ...
    <section class="page-content">
        <div class="container">
            <div class="intro-text">
                <h2 style="text-align: center; margin-bottom: 20px;">Meet Our Dedicated Teachers</h2>
                <p style="text-align: center; max-width: 800px; margin: 0 auto 50px; color: var(--light-text); font-size: 16px; line-height: 1.8;">
                    Our highly qualified and experienced faculty members are committed to providing quality education and nurturing the potential of every student. With diverse expertise and a passion for teaching, they create an inspiring learning environment.
                </p>
            </div>

            <div class="faculty-grid" id="facultyGrid">
                <!-- Faculty loaded dynamically -->
            </div>
        </div>
    </section>
